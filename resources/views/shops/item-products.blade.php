    ...
    <div class="col-md-3 padding-zero block-product-category">
        ...
        <div>
            <div class="rating-container rating-md rating-animate rating-disabled">
                ...
                <input name="input-start" value="{{ $product->point_rate }}" class="rating input-start hide" readonly="readonly">
            </div>
            <input type="button" class="button btn-add-cart btn-add-cart-search" value="@lang('categories.addCart')" 
